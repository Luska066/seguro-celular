            ...
            <div className='controlContentFooter w-[1200px] flex flex-col gap-[40px]'>
                ...
                <div className='flex justify-between part2Footer'>
                    <p className='text-[14px] w-[565px] paragraphFooter'>
                        ...
                        Processo SUSEP Nº 15414.900970/2014-26 (Proteção de bens). Consulte a íntegra das <a className={`text-[${Colors().lightFooterBlue}]`} href="https://www.zurich.com.br/pt-br/seguro-celular/condicoes-gerais">Condições Gerais do
